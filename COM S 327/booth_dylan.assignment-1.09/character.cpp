...
//  boulder,tree,path,mart,center,grass,clearing,mountain,forest,water,gate,bailey
  ...
  { PM, PM, 20, 60, 60, 25, 20, 25, 25, PM, PM, 50 },
  { PM, PM, 20, 60, 60, 30, 20, PM, PM, PM, PM, 50 },
...
void character::replenish() {
  ...
  character::item_bag.heal_pot_cnt = (character::item_bag.heal_pot_cnt > 5 ? character::item_bag.heal_pot_cnt : 5);
  character::item_bag.revive_cnt = (character::item_bag.revive_cnt > 5 ? character::item_bag.revive_cnt : 5);
  character::item_bag.pokeball_cnt = (character::item_bag.pokeball_cnt > 5 ? character::item_bag.pokeball_cnt : 5);

  character::item_bag.size = character::item_bag.heal_pot_cnt + character::item_bag.revive_cnt + character::item_bag.pokeball_cnt;
