...
#define location_2 "/.poke327/pokedex/pokedex/data/csv/"
...
extern std::vector<pokemon> p_list;
extern std::vector<moves> moves_list;
extern std::vector<pokemon_moves> p_moves_list;
extern std::vector<pokemon_species> p_species_list;
extern std::vector<experience> experience_list;
extern std::vector<type_names> type_names_list;
extern std::vector<pokemon_stats> p_stats_list;
extern std::vector<stats> stats_list;
extern std::vector<pokemon_types> p_types_list;
