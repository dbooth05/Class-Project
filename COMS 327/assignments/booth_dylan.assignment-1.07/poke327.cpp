...
int main(int argc, char *argv[])
{
  ...
  /* Uncomment this block to run game again.
  ...
  */
  ...
  if (argc > 1) {
    ...
    if (strcmp(argv[0], "pokemon") == 0) {
      load_choice = 0;
    } else if (strcmp(argv[0], "moves") == 0) {
      load_choice = 1;
    } else if (strcmp(argv[0], "pokemon_moves") == 0) {
      load_choice = 2;
    } else if (strcmp(argv[0], "pokemon_species") == 0) {
      load_choice = 3;
    } else if (strcmp(argv[0], "experience") == 0) {
      load_choice = 4;
    } else if (strcmp(argv[0], "type_names") == 0) {
      load_choice = 5;
    } else if (strcmp(argv[0], "pokemon_stats") == 0) {
      load_choice = 6;
    } else if (strcmp(argv[0], "stats") == 0) {
      load_choice = 7;
    } else if (strcmp(argv[0], "pokemon_types") == 0) {
      load_choice = 8;
    }

    load_csvs(load_choice);
  }
