...
class pokemon {
    public:
        ...
        void level_up() {
            level++;
            experience = (experience - (100 + (level * 5)) > 0 ? experience - (100 + (level * 5)) : 0);
            hp_max += floor(((stats.at(0).base_stat + iv_hp) * 2 * level) / 100) + level + 10;
