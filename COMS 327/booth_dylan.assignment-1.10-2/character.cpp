...
void character::replenish() {
  ...
  character::item_bag.heal_pot_cnt = (character::item_bag.heal_pot_cnt > 3 ? character::item_bag.heal_pot_cnt : 3);
  character::item_bag.revive_cnt = (character::item_bag.revive_cnt > 3 ? character::item_bag.revive_cnt : 3);
  character::item_bag.pokeball_cnt = (character::item_bag.pokeball_cnt > 5 ? character::item_bag.pokeball_cnt : 5);

  character::item_bag.count_size();
